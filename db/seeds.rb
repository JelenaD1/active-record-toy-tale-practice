...
Purchase.create(kid: Kid.first, toy: Toy.first, quantity: 10)
Purchase.create(kid: Kid.first, toy: Toy.second, quantity: 20)
Purchase.create(kid: Kid.second, toy: Toy.second, quantity: 30)
